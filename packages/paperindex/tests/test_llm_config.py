...
ALL_ENV_VARS = [
    ...
    "CHATGPT_API_KEY", "CHATGPT_BASE_URL", "CHATGPT_MODEL",
    "KIMI_API_KEY", "KIMI_BASE_URL", "KIMI_MODEL",
    "PAPERINDEX_LLM_MODEL",
    "ANTHROPIC_API_KEY", "ANTHROPIC_AUTH_TOKEN", "ANTHROPIC_MODEL", "ANTHROPIC_BASE_URL",
    "CURSOR_AGENT_ENABLED", "CURSOR_AGENT_MODEL", "CODEX_ENABLED", "CODEX_MODEL",
    "JOY_KIMI_ENABLED", "JOY_KIMI_MODEL",
    "JOY_GPT_ENABLED", "JOY_GPT_MODEL",
    "LLM_ROUTE_LIGHT", "LLM_ROUTE_MEDIUM", "LLM_ROUTE_HEAVY",
]
...
def test_resolve_llm_config_prefers_explicit_overrides(monkeypatch):
    ...
    config = resolve_llm_config({"api_key": "override-key", "base_url": "https://override.example/v1", "model": "override-model"})
...
def test_resolve_kimi_messages_url_accepts_base_or_messages_endpoint():
    assert _resolve_kimi_messages_url("https://api.kimi.com/coding") == "https://api.kimi.com/coding/v1/messages"
    assert _resolve_kimi_messages_url("https://api.kimi.com/coding/v1") == "https://api.kimi.com/coding/v1/messages"
    assert _resolve_kimi_messages_url("https://api.kimi.com/coding/v1/messages") == "https://api.kimi.com/coding/v1/messages"



def test_resolve_kimi_anthropic_base_url_normalizes_variants():
    assert _resolve_kimi_anthropic_base_url("https://api.kimi.com/coding") == "https://api.kimi.com/coding/"
    assert _resolve_kimi_anthropic_base_url("https://api.kimi.com/coding/v1") == "https://api.kimi.com/coding/"
    assert _resolve_kimi_anthropic_base_url("https://api.kimi.com/coding/v1/messages") == "https://api.kimi.com/coding/"
...
def test_llm_client_kimi_uses_anthropic_streaming(monkeypatch):
    ...
    monkeypatch.setattr("paperindex.llm.client._build_anthropic_client", lambda api_key, base_url: DummyClient())
